...
d.service.param={t:'master_users', mod:'profile',nama:res.id};
d.service.get(callback);

function callback(json){

res1=JSON.parse(json);
if (res1.status=='ok'){ d.setls('data',res1);
...
<div class="col-2-3">
<h1 id="username">${arr.username} ${res1.email} </h1>
...
// if (profiles[param]) {
// profile.model.profile.username=profiles[param].name;
// document.getElementById("username").innerText = profiles[param].name;
// document.getElementById("desc").innerText = profiles[param].desc;
// } else {
// document.getElementById("username").innerText = "Profile tidak ditemukan";
// document.getElementById("desc").innerText = "Gunakan URL seperti ?wawan atau ?sismadi";
// }
