...
host:'http://localhost/lms/api/profile.php',
...
kursus:{id:'profile',rpp:5,page:1,data:[
  {id:101,Nama:"Pemrograman Web",Sertifikat:'2024-12-01',Progress:"selesai",url:"kursus.controller.menu(1)"},
  {id:107,Nama:"Desain Web",Sertifikat:'2024-12-01',Progress:"selesai",url:"kursus.controller.menu(1)"},
  {id:113,Nama:"Pemrograman Mobile",Sertifikat:'2024-12-01',Progress:"selesai",url:"kursus.controller.menu(1)"},
]},

instruktur:{id:'profile',rpp:5,page:1,data:[
  {id:101,Nama:"Pemrograman Web",Sertifikat:'2024-12-01',Progress:"selesai",url:"kursus.controller.menu(1)"},
  {id:107,Nama:"Desain Web",Sertifikat:'2024-12-01',Progress:"selesai",url:"kursus.controller.menu(1)"},
  {id:113,Nama:"Pemrograman Mobile",Sertifikat:'2024-12-01',Progress:"selesai",url:"kursus.controller.menu(1)"},
]},
...
{id:2,nama:"Students",isi:"3",icon:"setting",url:"d.url('exam');"},
{id:2,nama:"Earnings",isi:"3",icon:"setting",url:"d.url('exam');"},
...
<h3>Instruktur</h3>
<div class="row"> ${d.view.table(profile.model.instruktur)}</div>
</div>

<div class="row shadow">
<h3>Kursus</h3>
<div class="row"> ${d.view.table(profile.model.kursus)}</div>
</div>
...
profile.model.profile.username=res.email;

d.gebi('content').innerHTML=profile.view.profile(profile.model.profile);


var param = window.location.search.substring(1).toLowerCase();

if (param) {
d.gebi('username').innerHTML=param;
this.getdata(param)
...
getdata:function(nama){

// peserta=1;
  d.service.host=profile.model.host;
  d.service.param={t:'master_users', mod:'lembaga',nama:nama};
...
profile.model.instruktur.data=res.instruktur;
profile.model.kursus.data=res.kursus;

log(res.kursus)
log(res.instruktur)

log(profile.model.instruktur)
log(profile.model.kursus)
